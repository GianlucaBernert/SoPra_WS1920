...
public class MovieMapper {
    ...
    public Movie insertMovie(Movie movie) {
    	...
    	try {
			...
			stm2.executeUpdate("INSERT INTO mobie (bo_id, name, genre, description, creationTimeStamp) VALUES ('"
								+movie.getId()
								+"*, '"+movie.getName()
								+"', '"+movie.getGenre()
    ...
    public Movie updateMovie(Movie movie) {
    	...
    	try {
    		...
    		Statement stmt = con.createStatement();
    		stmt.executeUpdate("UPDATE person Set name='"+movie.getName()
    ...
    public Vector<Movie> findMovieByPersonFK(int personFK) {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("SELECT businessownership.personFK FROM  businessownership WHERE businessownership.personFK= " + personFK);
